...
<input type="hidden"  name="lng" value="${val.location.x}" >
<input type="hidden" name="lat" value="${val.location.y}" >
                                                            <a class="js-map-search-item" data-lng="${val.location.x}" data-lat="${val.location.y}">
