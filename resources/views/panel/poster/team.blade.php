                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">همکاران
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ثبت همکاران</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">

                                        @foreach($edition->teammates as $key=>$team)
                                            <button class="btn btn-success btn-sm">{{$key+1}}</button>

                                            <div class="modal-dark mr-1 mb-1 d-inline-block">

                                                <x-destroy :id="$team->id" url="'/panel/editions/team/destroy'"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled class="form-control"
                                                                   value="{{$team->teammate->pages_count ?? ''}}">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled class="form-control"
                                                                   value="{{$team->teammate->questions_count ?? ''}}">
                                        ...
                                        @endforeach
                                        <hr class="new5">
                                        <form action="/panel/editions/{{$edition->id}}/team/update" method="post">
                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control " id=""
                                                                    ...
                                                                    @foreach($roles as $role)
                                                                        <option
                                                                            value="{{$role->id}}">{{$role->text}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
